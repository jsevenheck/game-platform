...
- F-02: `updateMaxRounds` nutzt `readFiniteNumber` und lehnt nicht-endliche, falsch typisierte und nicht-ganzzahlige Werte vor Änderung/Broadcast ab; gültige Werte bleiben im konfigurierten Bereich geklemmt. `socketHandlers.test.ts`: 12/12 bestanden, davon sechs ungültige Payload-Fälle; Prettier bestanden. Gesamttypecheck folgt im Abschlusslauf.
