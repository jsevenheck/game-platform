...
- `game_id`: one of `blackout`, `imposter`, `secret-signals`, `flip7`, `scout`, `estimate`, `kritzelagent`, `herd-mentality`
- `namespace`: `/party`, `/g/blackout`, `/g/imposter`, `/g/secret-signals`, `/g/flip7`, `/g/scout`, `/g/estimate`, `/g/kritzelagent`, `/g/herd-mentality`
