...
<template>
  <div class="flex flex-col items-center justify-center min-h-[80vh] gap-4">
    ...
    <div v-if="mode === 'menu'" class="flex flex-col gap-3 w-[280px]">
      ...
      />
      <button class="ui-btn-primary !bg-signals hover:!bg-signals-hover" @click="mode = 'create'">
        Create Room
      </button>
      <button
    ...
    <div v-else-if="mode === 'create'" class="flex flex-col gap-3 w-[280px]">
      ...
      />
      <button class="ui-btn-primary !bg-signals hover:!bg-signals-hover" @click="handleCreate">
        Create Room
      </button>
      <button
        class="ui-btn-ghost !text-muted-foreground hover:!text-foreground"
        @click="mode = 'menu'"
      >
        Back
      </button>
    ...
    <div v-else class="flex flex-col gap-3 w-[280px]">
      ...
      />
      <button class="ui-btn-primary !bg-signals hover:!bg-signals-hover" @click="handleJoin">
        Join Room
      </button>
      <button
        class="ui-btn-ghost !text-muted-foreground hover:!text-foreground"
