...
// Bidirectional socket index: socketId → { roomCode, playerId }. Factored
// into a shared helper (apps/platform/server/party/gameAuth.ts) since this
// was previously hand-rolled identically in every game — see that module's
// "Socket index helper" section for why.
